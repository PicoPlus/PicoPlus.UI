...
namespace PicoPlus.Services.SMS
{
    ...
    public class SmsServiceFactory
    {
        ...
        public ISmsService GetSmsService()
        {
            ...
            return provider switch
            {
                ...
                SmsProvider.IPPanel  => (ISmsService)_serviceProvider.GetService(typeof(IpPanelSmsService))!,
        ...
        private SmsProvider GetConfiguredProvider()
        {
            ...
            _logger.LogWarning("Invalid SMS provider configured: {Provider}. Defaulting to IPPanel", providerName);
            return SmsProvider.IPPanel;
        }
    }
    ...
    public class SmsService : ISmsService
    {
        ...
        {
            return _provider.SendDealClosedAsync(mobile, firstName, lastName, dealId, dealLink);
        }
    }
}
